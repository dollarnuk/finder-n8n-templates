...
- [x] **Адмін-панель користувачів** — перегляд зареєстрованих користувачів, статистики оплат та використання AI.
...
| GET | `/api/admin/users` | Список користувачів з аналітикою (admin) |
